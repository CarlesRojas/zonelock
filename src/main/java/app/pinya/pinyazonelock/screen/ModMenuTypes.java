...
public class ModMenuTypes {
    ...
    public static final RegistryObject<MenuType<ZoneLockCoreMenu>> ZONE_LOCK_CORE_MENU = MENUS
            .register("zone_lock_core_menu", () -> IForgeMenuType.create(ZoneLockCoreMenu::new));
